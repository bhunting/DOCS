...
* **jenkins** -- ... For Jenkins continuous integration server.  _(Passw*d: sw-dept-standard)_ 
...
* **10.22.72.227** -- **AUC Gui Dev/Test** _(AUC farm, inside)_ _(Login: aucuser, P*wd: aucuser, su: sw-dept-standard)_ [Atom board running Debian](AtomPrototypeMachines.md) _(assigned 27-Jan-2015)_ **UPDATE 11-Feb-2015**, Install new Debian Atom x86 Default Desktop Environment for testing
