...
* **10.22.72.227** -- **AUC Gui Dev/Test** _(AUC farm, inside)_ _(Login: aucuser, P*wd: aucuser, su: sw-dept-standard)_ [Atom board running Debian](AtomPrototypeMachines.md) _(assigned 27-Jan-2015)_ **UPDATE**, Install new Debian Atom x86 Default Desktop Environment for testing
