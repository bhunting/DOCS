...
* [Using/Writing GTests](TestUsingGTest.md)
* [Test Protocols (UNs, DIs, SRs, SSRs)](TestProtocols.md)

## Continuous Integration

* [Jenkins](JenkinsSetup.md)
* [jenkins.sh](jenkins.sh)
* [Initial Commit (PNG)](JenkinsAUCconfig.png)

## Version Control, File Management

* **Git** (for version control) [http://git-scm.com](http://git-scm.com)
* **GitHub Enterprise** (for site-hosting of git repositories) [https://github.com/](https://github.com/)
